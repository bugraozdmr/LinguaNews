...
const SavedToLaterNews = () => {
  ...
  const getSavedNews = async () => {
    try {
      const storedNews = await AsyncStorage.getItem("laterReadNews"); // Use "laterReadNews" instead of "savedNews"
  ...
  return (
    <View style={styles.container}>
      {/* Title */}
      <Text style={styles.header}>Reading List</Text>
...
export default SavedToLaterNews;
